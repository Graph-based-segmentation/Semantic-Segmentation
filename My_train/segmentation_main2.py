...
def main():
    ...
    my_mean_std = ([0.688824, 0.270588, 0.305882], [0.041225, 0.032375, 0.026271])
...
def validate(val_loader, net, criterion, optimizer, epoch, train_args, restore, visualize):
    ...
    # mean_iou = compute_mean_iou(pred=predictions_all, label=gts_all)
    ...
    if mean_iu > train_args.best_record['mean_iu']:
        ...
        # )
        snapshot_name = 'epoch_%d_loss_%.6f_acc_%.6f_acc_cls_mean_%.6f_mean-iu_%.6f_fwavacc_%.6f_lr_%.10f' % (
...
if __name__ == '__main__':
    ...
    src_model = "/home/mk/Semantic_Segmentation/DenseASPP-master/models/DenseASPP_v2.py"

    copy_path = os.path.join(ckpt_path, 'TensorboardX', ImageNet, exp_name_ImageNet,
                             "segmentation_main2_" + "v0{}_{}.py".format(x, version))
