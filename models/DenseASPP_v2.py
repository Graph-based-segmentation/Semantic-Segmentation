...
class DenseASPP(nn.Module):
    ...
    * output_scale can only set as 8 or 16
    ...
    def __init__(self, model_cfg, n_class=19, output_stride=8):
        ...
        # """===================================================arbitrary code=========================================="""
        # self.ASPP_3_ARB = _DenseAsppBlock(input_num=3, num1=3, num2=3,
        #                                   dilation_rate=6, drop_out=dropout0, bn_start=True)
        #
        # self.ASPP_6_ARB = _DenseAsppBlock(input_num=num_features, num1=d_feature0, num2=d_feature1,
        #                                   dilation_rate=6, drop_out=dropout0, bn_start=True)
        #
        # self.ASPP_12_ARB = _DenseAsppBlock(input_num=num_features, num1=d_feature0, num2=d_feature1,
        #                                    dilation_rate=12, drop_out=dropout0, bn_start=True)
        #
        # self.ASPP_18_ARB = _DenseAsppBlock(input_num=num_features, num1=d_feature0, num2=d_feature1,
        #                                    dilation_rate=18, drop_out=dropout0, bn_start=True)
        #
        # self.ASPP_24_ARB = _DenseAsppBlock(input_num=num_features, num1=d_feature0, num2=d_feature1,
        ...
        self.ASPP_24 = _DenseAsppBlock(input_num=num_features + d_feature1 * 4, num1=d_feature0, num2=d_feature1,
                                       dilation_rate=24, drop_out=dropout0, bn_start=True)
        """================================================MK========================================================"""
        self.ASPP_v2_1 = _DenseAsppBlock_v2(input_num=num_features, num1=d_feature0, num2=d_feature1,
                                            dilation_rate=3, drop_out=dropout0, bn_start=True)

        self.ASPP_v2_2 = _DenseAsppBlock_v2(input_num=num_features + d_feature1 * 1, num1=d_feature0, num2=d_feature1,
                                            dilation_rate=6, drop_out=dropout0, bn_start=True)

        self.ASPP_v2_3 = _DenseAsppBlock_v2(input_num=num_features + d_feature1 * 2, num1=d_feature0, num2=d_feature1,
                                            dilation_rate=12, drop_out=dropout0, bn_start=True)

        self.ASPP_v2_4 = _DenseAsppBlock_v2(input_num=num_features + d_feature1 * 3, num1=d_feature0, num2=d_feature1,
                                            dilation_rate=18, drop_out=dropout0, bn_start=True)

        self.ASPP_v2_5 = _DenseAsppBlock_v2(input_num=num_features + d_feature1 * 4, num1=d_feature0, num2=d_feature1,
                                            dilation_rate=24, drop_out=dropout0, bn_start=True)
        """------------------------------------------------MK--------------------------------------------------------"""
        ...
        self.classification = nn.Sequential(
            ...
            # nn.Conv2d(in_channels=832, out_channels=n_class, kernel_size=1, padding=0),
    ...
    def forward(self, _input):
        ...
        # batch x 832 x 64 x 64

        """================================================MK========================================================"""
        aspp3_v2 = self.ASPP_v2_1(feature)
        feature_aspp3_v2 = torch.cat((aspp3_v2, feature), dim=1)

        aspp6_v2 = self.ASPP_v2_2(feature_aspp3_v2)
        feature_aspp6_v2 = torch.cat((aspp6_v2, feature_aspp3_v2), dim=1)

        aspp12_v2 = self.ASPP_v2_3(feature_aspp6_v2)
        feature_aspp12_v2 = torch.cat((aspp12_v2, feature_aspp6_v2), dim=1)
        ...
        """================================================MK========================================================"""
        cls = self.classification(output)                  # batch x num_class x 512 x 512

        return cls
# """=====================================================arbitrary code==============================================="""
# class _atrous_conv(nn.Sequential):
#
#     def __init__(self, input_num, dilation_rate):
#         super(_atrous_conv, self).__init__()
#
#         self.add_module('aconv.1', nn.Conv2d(in_channels=input_num, out_channels=input_num, kernel_size=3,
#                                              dilation=dilation_rate, stride=1, padding=3))
#     def forward(self, _input):
#         feature = super(_atrous_conv, self).forward(_input)
#
#         return feature
# """=====================================================arbitrary code==============================================="""

class _DenseAsppBlock_v2(nn.Sequential):
    ...
    def __init__(self, input_num, num1, num2, dilation_rate, drop_out, bn_start=True):
        ...
        super(_DenseAsppBlock_v2, self).__init__()
        if bn_start:
    ...
    def forward(self, _input):
        feature = super(_DenseAsppBlock_v2, self).forward(_input)
